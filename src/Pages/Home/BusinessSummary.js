  ...
  return (
    <div className="my-20 text-xl">
      ...
      <div className="w-full flex justify-center">
        <div class="stats stats-vertical lg:stats-horizontal shadow  lg:flex justify-center items-center lg:my-10">
          <div class="stat">
            ...
            <div class="stat-value text-secondary">75+ </div>
            <div class="stat-desc"> 80+ Tools Available</div>
          </div>

          <div class="stat">
            <div class="stat-figure text-[#570DF8]">
              <img
                className=" w-14"
            ...
            <div class="stat-title">Customers Globally</div>
            <div class="stat-value text-[#570DF8]">458+</div>
            <div class="stat-desc">19% more than last month</div>
          </div>
          ...
          <div class="stat">
            ...
            <div class="stat-value text-warning">3.7M+</div>
            <div class="stat-desc">3.7M+ Last Year's Annual Revenue </div>
          </div>
          ...
          <div class="stat">
            ...
            <div class="stat-title">Clients Feedbacks</div>
